...
faces_norm2 = importdata('faces_norm2.mat');
faces_norm2 = reshape(faces_norm2,[1000 96 96]);
X = tensor(faces_norm2);
...
title("Reconstruction error curves (using np.linalg.norm normalization)");
